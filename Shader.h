...
extern ID3D11PixelShader*  gBlur_PostProcess;
extern ID3D11PixelShader*  gPyramidBlur_PostProcess;
extern ID3D11PixelShader*  gGaussianBlurH_PostProcess;
extern ID3D11PixelShader*  gCopy_PostProcess;
